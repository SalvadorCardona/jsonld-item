...
describe("isApiIri with a custom prefix", () => {
  it("accepts a different route prefix", () => {
    expect(isApiIri("/v2/articles/42", "/v2/")).toBeTruthy()
    expect(isApiIri("/api/articles/42", "/v2/")).toBeFalsy()
  })
})
